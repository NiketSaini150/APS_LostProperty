    ...
    public partial class user : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_LostItem", x => x.LostItemID);
                    table.ForeignKey(
                        name: "FK_LostItem_Category_CategoryID",
                        column: x => x.CategoryID,
                        principalTable: "Category",
                        principalColumn: "CategoryID",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_LostItem_Location_LocationID",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    MatchedLostItemID = table.Column<int>(type: "int", nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Claim_MatchedLostItemID",
                table: "Claim",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_LostItem_CategoryID",
                table: "LostItem",
                column: "CategoryID");

            migrationBuilder.CreateIndex(
                name: "IX_LostItem_LocationID",
                table: "LostItem",
                column: "LocationID");
        }
